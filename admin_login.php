...
<body>
    ...
    <section id="login" class="pb-5">
        <div class="container mt-5 mb-5 shadow">
            ...
            <form action="admin_login.php" method="post" class="was-validated">
            ...
            <h5 class="mt-4"><a href="login.php">Login As Normal User</a></h5>
        </div>
    </section>    
    <?php
        if(isset($_POST['lbtn'])){
